...
export const Header: FunctionComponent = () => {
	return (
		<div className='text-2xl gap-12 justify-between font-semibold py-6 uppercase hidden lg:flex items-center bg-white fixed top-0 left-0 w-screen px-10 z-30'>
